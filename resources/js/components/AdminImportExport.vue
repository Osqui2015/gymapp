<template>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <Breadcrumbs
            :items="[{ label: 'Inicio', href: '/dashboard' }, { label: 'Importar / Exportar' }]"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                    ...
                    <div class="space-y-3">
                        <button
                            ...
                            class="w-full flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-xl transition-colors"
                        >
                ...
                >
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mb-6">
                        Sube archivos CSV para importar datos masivamente.
                    </p>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                            ...
                            <div class="flex items-center gap-4">
                                <label class="flex-1 cursor-pointer">
                                    <input
                                        @change="handleUserFile"
                                        type="file"
                                        accept=".csv,.txt"
                                        class="hidden"
                                    />
                                    <div
                                        class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-6 text-center hover:border-indigo-500 dark:hover:border-indigo-400 transition-colors"
                                    >
                                        <svg
                                ...
                                <button
                                    ...
                                    :disabled="!userFile || importingUsers"
                                    class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50"
                                >
                            ...
                            <div v-if="importingUsers" class="mt-3">
                                ...
                                >
                                    <div
                                        class="h-full bg-gradient-to-r from-indigo-500 to-purple-500 transition-all duration-200"
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                            ...
                            <div class="flex items-center gap-4">
                                <label class="flex-1 cursor-pointer">
                                    <input
                                        @change="handleEjercicioFile"
                                        type="file"
                                        accept=".csv,.txt"
                                        class="hidden"
                                    />
                                    <div
                                        class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-6 text-center hover:border-green-500 dark:hover:border-green-400 transition-colors"
                                    >
                                        <svg
                                            class="w-10 h-10 mx-auto text-gray-400 mb-2"
                                            fill="none"
                                ...
                                <button
                                    @click="importarEjercicios"
                                    :disabled="!ejercicioFile || importingEjercicios"
                            ...
                            <div v-if="importingEjercicios" class="mt-3">
                                ...
                                >
                                    <div
                                        class="h-full bg-gradient-to-r from-green-500 to-emerald-500 transition-all duration-200"
                                        :style="{ width: `${ejercicioProgress}%` }"
                                    ></div>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <p
                            ...
                            "
                        >
                            Creados: {{ importResult.created }} | Procesados:
                        ...
                        <div v-if="importResult.errors?.length" class="mt-2">
                            ...
                            <ul
                                class="text-xs text-red-500 dark:text-red-400 list-disc list-inside"
                            >
            ...
            <!-- Template Download -->
            <div
                class="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700"
            >
...
Nombre,Nick,Email,Rol,Teléfono
...
Carlos Trainer,carlos.trainer,carlos@email.com,trainer,555555555</pre>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                        ...
                        <pre class="text-xs text-gray-600 dark:text-gray-400 overflow-x-auto">
Nombre,Grupo Muscular,Equipamiento,Visible,Descripción
...
const handleEjercicioFile = (e) => {
    ejercicioFile.value = e.target.files[0];
    importResult.value = null;
};

const exportarUsuarios = () => {
    window.location.href = '/api/admin/export/users';
    showToast('Descargando usuarios...');
};
const exportarEjercicios = () => {
    window.location.href = '/api/admin/export/ejercicios';
    showToast('Descargando ejercicios...');
};
...
const importarEjercicios = async () => {
    ...
    try {
        const data = await uploadWithProgress(
            '/api/admin/import/ejercicios',
            ejercicioFile.value,
            (p) => (ejercicioProgress.value = p)
        );
