            ...
            <div v-else>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                    ...
                    >
                        ...
                        <p class="text-2xl font-bold text-green-600 dark:text-green-400">
                            {{ stats.resumen.usuarios_activos }}
                        </p>
                    </div>
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 border border-gray-200 dark:border-gray-700"
                    ...
                    >
                        ...
                        <p class="text-2xl font-bold text-orange-600 dark:text-orange-400">
                            {{ stats.resumen.total_entrenamientos }}
                        </p>
                    </div>
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 border border-gray-200 dark:border-gray-700"
                    >
                        ...
                        <p class="text-2xl font-bold text-cyan-600 dark:text-cyan-400">
                            {{ stats.resumen.entrenamientos_hoy }}
                        </p>
                    </div>
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 border border-gray-200 dark:border-gray-700"
                    >
                        ...
                        <p class="text-2xl font-bold text-pink-600 dark:text-pink-400">
                            {{ stats.resumen.usuarios_nuevos_mes }}
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            <div
                                v-for="mes in stats.usuarios_por_mes"
                                :key="mes.mes"
                                class="flex items-center gap-3"
                            >
                                <span class="text-sm text-gray-500 dark:text-gray-400 w-20">{{
                                    mes.mes
                                }}</span>
                                <div
                                ...
                                <span
                                    class="text-sm font-semibold text-gray-700 dark:text-gray-300 w-10 text-right"
                                    >{{ mes.total }}</span
                                >
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div class="grid grid-cols-6 gap-2">
                            <div
                                v-for="hora in stats.horas_pico"
                                :key="hora.hora"
                                class="text-center"
                            >
                                <div
                                    ...
                                    :class="
                                        hora.total > maxHorasPico * 0.7
                                            ? 'bg-red-100 dark:bg-red-900/30'
                                            : hora.total > maxHorasPico * 0.4
                ...
                >
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                >
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <span
                                            class="px-2 py-1 bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400 rounded-full text-xs font-semibold"
                                            >{{ ej.veces_usado }}</span
                                        >
                                    </td>
                                    <td
                    ...
                    <div class="md:hidden divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        >
                            <span
                                class="flex-shrink-0 w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 flex items-center justify-center font-bold text-sm"
                            >
                                {{ index + 1 }}
                            </span>
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    {{ ej.veces_usado }} usos ·
                                    {{ formatNumber(ej.reps_totales) }} reps
                                </p>
                            </div>
                    ...
                    <div
                        v-if="stats.ejercicios_populares.length === 0"
