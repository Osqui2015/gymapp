<template>
    ...
    >
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <Breadcrumbs
                :items="[{ label: 'Inicio', href: '/dashboard' }, { label: 'Nutrición' }]"
            />
            <!-- Header -->
            <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">
                        Registra tus calorías, macronutrientes e hidratación diaria
                    </p>
                </div>
                <a
                    href="/dashboard"
            ...
            <div
                class="mb-8 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 rounded-2xl shadow-md p-5 border border-indigo-200 dark:border-indigo-800/50"
            >
                <div
                    v-if="loadingTdee"
                ...
                <div
                    v-else-if="!tdee.inputs_completos"
                    class="flex flex-col md:flex-row items-start md:items-center gap-4 justify-between"
                >
                    <div>
                        <h3
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                            ...
                            <span
                                v-if="tdee.faltantes?.length"
                                class="block mt-1 font-semibold text-amber-700 dark:text-amber-400"
                            >
                ...
                <div v-else class="grid sm:grid-cols-4 gap-4">
                    <div class="text-center sm:text-left">
                        ...
                        <p class="text-2xl font-black text-gray-900 dark:text-white font-mono">
                            {{ tdee.bmr }}
                        </p>
                    ...
                    <div class="text-center sm:text-left">
                        ...
                        <p
                            class="text-2xl font-black text-indigo-600 dark:text-indigo-400 font-mono"
                        >
                            {{ tdee.tdee }}
                        </p>
                    ...
                    <div class="text-center sm:text-left">
                        ...
                        <p
                            class="text-2xl font-black text-purple-600 dark:text-purple-400 font-mono"
                        >
                            {{ tdee.calorias_target }}
                        </p>
                    ...
                    <div class="text-center sm:text-left flex flex-col justify-between">
                        ...
                        <p class="text-sm font-mono text-gray-700 dark:text-gray-300 leading-tight">
                            <span class="text-red-500 font-bold">{{ tdee.macros.proteinas }}g</span>
                            prot ·
                            <span class="text-amber-500 font-bold"
                                >{{ tdee.macros.carbohidratos }}g</span
                            >
                            carb ·
                            <span class="text-emerald-500 font-bold"
                                >{{ tdee.macros.grasas }}g</span
                            >
                            gras
                        </p>
                        <button
            ...
            <Teleport to="body">
                <Transition name="modal">
                    ...
                    >
                        ...
                        <div
                            class="relative w-full max-w-2xl bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 max-h-[92vh] overflow-y-auto"
                        >
                            <button
                                type="button"
            ...
            <!-- Date selector -->
            <div
                class="mb-8 bg-white dark:bg-gray-800 rounded-2xl shadow-md p-4 border border-gray-100 dark:border-gray-700 flex justify-between items-center"
            >
                <button
                    @click="cambiarDia(-1)"
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700 md:col-span-1 flex flex-col items-center"
                >
                    <h3
                        class="text-base font-bold text-gray-700 dark:text-gray-300 mb-6 text-center w-full"
                    >
                        Resumen Calórico
                    </h3>
                    ...
                    <div
                        class="w-full space-y-4 border-t border-gray-100 dark:border-gray-700 pt-4"
                    >
                        <div class="space-y-1">
                            <div class="flex justify-between text-xs font-semibold">
                                ...
                                <span class="font-mono text-gray-600 dark:text-gray-400">
                                    {{ diario.proteinas
                                    }}<span v-if="tdee.inputs_completos"
                                        >/{{ tdee.macros.proteinas }}g</span
                                    >
                                </span>
                            </div>
                            <div
                            ...
                            >
                                <div
                                    ...
                                    :style="{
                                        width: `${macroPct(diario.proteinas, tdee.macros?.proteinas)}%`,
                                    }"
                                ></div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            >
                                <div
                                    ...
                                    :style="{
                                        width: `${macroPct(diario.carbohidratos, tdee.macros?.carbohidratos)}%`,
                                    }"
                                ></div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            >
                                <div
                                    ...
                                    :style="{
                                        width: `${macroPct(diario.grasas, tdee.macros?.grasas)}%`,
                                    }"
                                ></div>
                            </div>
                        </div>
                ...
                <div class="md:col-span-2 space-y-8">
                    ...
                    >
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button
                                type="button"
                                @click="mostrarComidasFrecuentes = true"
                                class="text-xs font-semibold px-3 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-colors flex items-center gap-1.5 border border-indigo-100 dark:border-indigo-900/50"
                            >
                    ...
                    >
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <span
                                class="text-xs font-bold font-mono text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/20 px-2.5 py-1 rounded-full"
                            >
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-6">
                            Lleva un registro de los vasos de agua consumidos hoy (aprox 250ml por
                            vaso). ¡Mantente hidratado!
                        </p>
                        ...
                        <div class="flex flex-col items-center gap-6">
                            ...
                            <div class="flex flex-wrap justify-center gap-4 max-w-sm">
                                <button
                                    ...
                                    :class="[
                                        index <= diario.agua_vasos
                                            ? 'bg-blue-100 dark:bg-blue-950/30'
                                            : 'bg-transparent',
                                    ]"
                                    :title="
                                        index <= diario.agua_vasos
                                            ? 'Haga clic para quitar vaso'
                                            : 'Haga clic para agregar vaso'
                                    "
                                ...
                                >
                                    ...
                                    <div
                                        class="absolute top-0 left-0 right-0 h-1 border-t-2 border-blue-400/80 dark:border-blue-500"
                                    ></div>
                                    <!-- Water Level -->
                                    <div
                    ...
                    <!-- Bienestar y Recuperación Diaria -->
                    <BienestarCard :fecha="fechaSeleccionada" />
                </div>
            </div>
        </div>

        <!-- Modal de Comidas Frecuentes -->
        <ComidasFrecuentesModal
            :is-open="mostrarComidasFrecuentes"
            @close="mostrarComidasFrecuentes = false"
            @sumar-comida="onSumarComidaFrecuente"
        />
    </div>
</template>
...
import ComidasFrecuentesModal from './nutricion/ComidasFrecuentesModal.vue';
import BienestarCard from './nutricion/BienestarCard.vue';
...
const mostrarComidasFrecuentes = ref(false);
...
const onSumarComidaFrecuente = async (comida) => {
    form.value.calorias = (Number(form.value.calorias) || 0) + Number(comida.calorias || 0);
    form.value.proteinas = (Number(form.value.proteinas) || 0) + Number(comida.proteinas || 0);
    form.value.carbohidratos =
        (Number(form.value.carbohidratos) || 0) + Number(comida.carbohidratos || 0);
    form.value.grasas = (Number(form.value.grasas) || 0) + Number(comida.grasas || 0);
    mostrarComidasFrecuentes.value = false;
    await guardarNutricion();
};
