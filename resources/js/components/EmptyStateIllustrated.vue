...
<template>
    <div class="flex flex-col items-center justify-center text-center py-10 px-6">
        ...
        <p
            v-if="description"
            class="text-sm md:text-base text-gray-500 dark:text-gray-400 max-w-md mx-auto mb-6"
        >
            {{ description }}
        </p>
...
const ILLUSTRATIONS = {
    ...
    'no-rutinas': () =>
        h('svg', ICON_PROPS(), [
            ...
            h('path', {
                d: 'M30 95 Q50 85 70 95 Q90 105 110 95 Q130 85 150 95',
                stroke: '#5eead4',
                'stroke-width': '2',
                fill: 'none',
                opacity: '0.5',
    ...
    'no-notifs': () =>
        h('svg', ICON_PROPS(), [
            // Campana
            h('path', {
                d: 'M70 90 Q70 60 100 55 Q130 60 130 90 L140 110 L60 110 Z',
                fill: '#a5b4fc',
            }),
            ...
            h(
                'text',
                { x: '155', y: '40', 'font-size': '12', fill: '#fbbf24', 'font-weight': 'bold' },
                'z'
            ),
            h(
                'text',
                { x: '162', y: '32', 'font-size': '9', fill: '#fbbf24', 'font-weight': 'bold' },
                'z'
            ),
        ]),
    ...
    'no-alumnos': () =>
        h('svg', ICON_PROPS(), [
            ...
            h('path', {
                d: 'M110 95 Q110 80 130 80 Q150 80 150 95 L150 110 L110 110 Z',
                fill: '#a78bfa',
                opacity: '0.5',
            }),
            // +
