                        ...
                        >
                            <span class="inline-flex items-center gap-1">
                                ...
                                <template v-if="sortable && col.sortable !== false">
                                    <span class="text-xs" :class="caretClass(col)">{{
                                        caret(col)
                                    }}</span>
                                </template>
                            </span>
        ...
        <div class="md:hidden space-y-3">
            <slot name="cards" :rows="displayRows">
                ...
                >
                    ...
                    <div
                        v-if="$slots.actions"
                        class="pt-2 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-1"
                    >
...
const props = defineProps({
    ...
    theadClass: {
        type: String,
        default: 'bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 uppercase text-xs',
    },
    tbodyClass: {
        type: String,
        default: 'divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800',
    },
