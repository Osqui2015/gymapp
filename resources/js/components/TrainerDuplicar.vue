    ...
    <div class="min-h-screen bg-gray-50 dark:bg-[var(--color-obsidian-base)] py-8">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mt-1">
                        Crea nuevas rutinas basadas en las existentes
                    </p>
                </div>
                <a
                    href="/dashboard"
            ...
            <div v-else>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 mb-8"
                >
                    <h3
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label
                                ...
                                >Seleccionar Rutina Original</label
                            >
                            <select
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"
                                >Nombre para la Nueva Rutina</label
                            >
                            <input
                    ...
                    >
                        <h4 class="font-semibold text-indigo-700 dark:text-indigo-300 mb-2">
                            Detalles de la Rutina Original:
                        </h4>
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm">
                            <div>
                                <span class="text-gray-500">Nivel:</span>
                                <span class="font-medium ml-1 text-gray-900 dark:text-white">{{
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ rutina.dias }} días • {{ rutina.modalidad }}
                                    </p>
                                </div>
                            </div>
