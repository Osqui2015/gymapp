<template>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <Breadcrumbs
            :items="[{ label: 'Inicio', href: '/dashboard' }, { label: 'Mis Ejercicios' }]"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mt-1">
                        Crea ejercicios solo visibles para ti y tus alumnos
                    </p>
                </div>
            ...
            <div v-else>
                ...
                <div v-if="ejerciciosAgrupados.length > 0" class="space-y-6">
                    <div
                        v-for="grupo in ejerciciosAgrupados"
                        :key="grupo.nombre"
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700"
                    >
                        <div
                            class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center"
                        >
                            <h3
                            ...
                            <span
                                class="px-3 py-1 bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-300 rounded-full text-sm font-semibold"
                            >
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            <div
                                v-for="ejercicio in grupo.ejercicios"
                                :key="ejercicio.id"
                                class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-between"
                            >
                                <div class="flex items-center gap-4">
                                    <div
                                        class="bg-indigo-100 dark:bg-indigo-900/30 w-12 h-12 rounded-lg flex items-center justify-center"
                                    >
...
const eliminarEjercicio = async (ejercicio) => {
    ...
    const confirmed = await toast.confirm(`¿Eliminar el ejercicio "${ejercicio.nombre}"?`, {
        title: 'Eliminar ejercicio',
