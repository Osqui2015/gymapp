<template>
    ...
    >
        ...
        <div
            class="px-5 py-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-750 border-b border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-between gap-3"
        >
            <div class="flex items-center gap-3">
                <span class="text-sm font-bold text-gray-800 dark:text-white">
                    {{ ejerciciosAgrupados.length }}
                    {{ ejerciciosAgrupados.length === 1 ? 'ejercicio' : 'ejercicios' }}
                </span>
                <span class="text-xs text-gray-500 dark:text-gray-400">·</span>
                <span
                    class="text-xs font-semibold"
                    :class="
                        totalCompletadas === totalSeries && totalSeries > 0
                ...
                <div
                    class="w-20 sm:w-28 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden hidden sm:block"
                >
                    <div
            ...
            >
                ...
                >
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                            ...
                            <div
                                ...
                                class="flex items-center gap-1.5 mt-1 text-xs text-indigo-700 dark:text-indigo-300"
                            >
                                <span>💡</span>
                                <span class="italic font-medium truncate">{{
                                    ejercicio.notas
                                }}</span>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center gap-2 shrink-0">
                        <span
                            class="hidden sm:inline-flex items-center gap-1 text-xs text-orange-600 dark:text-orange-400 font-medium px-2 py-1 rounded bg-orange-50 dark:bg-orange-950/40"
                        >
                        ...
                        >
                            {{ ejercicioCompleto(ejercicio) ? '✓ ' : ''
                            }}{{ completadasPorEjercicio(ejercicio) }}/{{ ejercicio.series.length }}
                            series
                        </span>
                    </div>
                </button>
                ...
                <div
                    v-if="estaAbierto(ejercicio.nombre)"
                ...
                >
                    ...
                    <div class="hidden md:block overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead>
                                <tr
                                    class="bg-gray-50/70 dark:bg-gray-900/30 border-b border-gray-100 dark:border-gray-700 text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400"
                                >
                                    <th class="px-4 py-2.5 text-center font-bold w-16">Serie</th>
                                    <th class="px-4 py-2.5 text-center font-bold w-28">
                                        Reps Obj.
                                    </th>
                                    <th class="px-4 py-2.5 text-center font-bold w-32">
                                        Reps hechas
                                    </th>
                                    <th class="px-4 py-2.5 text-center font-bold w-32">
                                        Peso (kg)
                                ...
                                <tr
                                    ...
                                    :class="
                                        fila.completado
                                            ...
                                            : 'bg-white dark:bg-gray-800 hover:bg-gray-50/60 dark:hover:bg-gray-750'
                                    "
                                >
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <span
                                            class="text-orange-600 dark:text-orange-400 font-medium text-xs"
                                        >
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <div class="inline-flex flex-col items-center gap-1">
                                            <div
                                                class="inline-flex rounded-md border border-gray-200 dark:border-gray-700 overflow-hidden text-[10px]"
                                            >
                                                <button
                                                    type="button"
                                                    :class="[
                    ...
                    <div
                        class="md:hidden divide-y divide-gray-100 dark:divide-gray-700/60 bg-white dark:bg-gray-800"
                    >
                        <div
                            v-for="fila in ejercicio.series"
                            :key="`${fila.uid}-mobile`"
                            ...
                            :class="
                                fila.completado ? 'bg-emerald-50/30 dark:bg-emerald-950/15' : ''
                            "
                        >
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    >
                                        ...
                                        <strong class="text-gray-700 dark:text-gray-300"
                                            >{{ fila.reps_min }} - {{ fila.reps_max }} reps</strong
                                        >
                                    </span>
                                </div>
                            ...
                            <div class="flex items-center justify-between gap-2 pt-1">
                                <div class="flex items-center gap-2">
                                    ...
                                    >
                                    <div
                                        class="inline-flex rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden text-[10px]"
                                    >
                                        <button
                                            type="button"
                                            :class="[
        ...
        <!-- Botonera inferior -->
        <div
            class="p-5 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 border-t border-gray-200 dark:border-gray-700"
        >
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <button
                    ...
                    :class="[
                        'text-white px-8 py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg',
                        botonSiguienteClass,
                    ]"
                >
                    {{ textoBotonSiguiente }}
...
const ejerciciosAgrupados = computed(() => {
    ...
    props.filasSerie.forEach((fila) => {
        ...
        if (!grupo.superserie_grupo && fila.superserie_grupo)
            grupo.superserie_grupo = fila.superserie_grupo;
