<template>
    <div>
        ...
        <div
            ...
            class="mb-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-5 border border-gray-100 dark:border-gray-700"
        >
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        Monitorea los cambios de tus medidas en el tiempo de forma interactiva
                    </p>
                </div>
                <select
        ...
        <div class="grid lg:grid-cols-2 gap-8">
            <!-- Form -->
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 border border-gray-100 dark:border-gray-700 h-fit"
            >
                <h2
                ...
                <form @submit.prevent="$emit('save', form)" class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                        <h3
                            class="text-base font-semibold text-gray-700 dark:text-gray-300 mb-4 flex items-center gap-2"
                        >
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-gray-500 dark:text-gray-400 mb-4 italic">
            ...
            <!-- Historial -->
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 border border-gray-100 dark:border-gray-700"
            >
                <h2
                    class="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2"
                >
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        >
                            <tr v-if="progresos.length === 0">
                                ...
                                >
                                    <svg
                                        class="mx-auto w-12 h-12 text-gray-300 dark:text-gray-600 mb-3"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                    >
                            ...
                            >
                                <td
                                    class="px-3 py-3 whitespace-nowrap text-sm font-semibold text-gray-900 dark:text-white"
                                >
                                    {{ formatFecha(p.fecha) }}
                                </td>
                                <td
                                    class="px-3 py-3 whitespace-nowrap text-sm text-center text-gray-600 dark:text-gray-300 font-mono"
                                >
                                    {{ p.peso ? p.peso + ' kg' : '-' }}
                                </td>
                                <td
                    ...
                    >
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            ...
                            <div
                                ...
                                class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-2.5"
                            >
                                <p
                                    class="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wider font-semibold"
                                >
        ...
        <!-- Tips -->
        <div
            class="mt-8 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/10 dark:to-purple-900/10 rounded-2xl p-4 sm:p-6 border border-indigo-100 dark:border-indigo-900/30"
        >
            <h3
                class="text-lg font-bold text-indigo-900 dark:text-indigo-100 mb-4 flex items-center gap-2"
            >
                <svg
                    class="w-5 h-5 text-indigo-500"
                    fill="none"
            ...
            <div
                class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 text-xs text-indigo-800 dark:text-indigo-200"
            >
