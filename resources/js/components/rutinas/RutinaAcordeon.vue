    ...
    >
        ...
        >
            <div class="flex items-center flex-wrap gap-2">
                ...
                <span
                    class="px-3 py-1 text-sm font-medium bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300 rounded-full"
                >
            ...
            >
                ...
                >
                    <div class="flex items-center">
                        ...
                        <span class="font-semibold text-indigo-950 dark:text-indigo-300">{{
                            dia.nombre
                        }}</span>
                        <span class="ml-2 text-xs text-indigo-500 dark:text-indigo-400"
                            >({{ dia.ejercicios.length }} ejercicios)</span
                        >
                    </div>
                    <svg
                ...
                <div
                    v-if="openDias.includes(dia.nombre)"
                    class="p-5 bg-gray-50/30 dark:bg-gray-900/30 overflow-x-auto"
                >
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr
                                class="bg-white dark:bg-gray-800 border-b-2 border-gray-200 dark:border-gray-700"
                            >
                                <th
                                    class="px-4 py-3 text-left font-bold text-gray-700 dark:text-gray-300"
                                >
                                    Ejercicio
                                </th>
                                <th
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            >
                                ...
                                <td class="px-4 py-3 text-center text-gray-700 dark:text-gray-300">
                                    <span
                                        class="px-2 py-1 bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300 rounded font-semibold"
                                        >{{ ejercicio.series }}</span
                                    >
                                </td>
                                <td class="px-4 py-3 text-center text-gray-700 dark:text-gray-300">
                                    {{ ejercicio.reps_min }} - {{ ejercicio.reps_max }}
                                </td>
                                <td class="px-4 py-3 text-center text-gray-700 dark:text-gray-300">
                                    <span class="text-orange-600 dark:text-orange-400 font-medium"
                                        >{{ ejercicio.descanso_min }} min</span
                                    >
                                </td>
                            </tr>
                        </tbody>
...
const getSuperserieClass = (ejercicio) => {
    ...
    switch (grupo) {
        ...
        case 2:
            return 'border-l-4 border-emerald-500 bg-emerald-50/10 dark:bg-emerald-950/20';
        case 3:
            return 'border-l-4 border-pink-500 bg-pink-50/10 dark:bg-pink-950/20';
        case 4:
            return 'border-l-4 border-amber-500 bg-amber-50/10 dark:bg-amber-950/20';
        default:
            return 'border-l-4 border-gray-500 bg-gray-50/10 dark:bg-gray-950/20';
    }
};
</script>
