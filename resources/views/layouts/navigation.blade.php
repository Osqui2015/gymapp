<nav x-data="{ open: false }" class="hidden md:block bg-white/85 dark:bg-[var(--color-obsidian-base)]/85 backdrop-blur-md border-b border-gray-200 dark:border-[var(--color-obsidian-border)] sticky top-0 z-50">
